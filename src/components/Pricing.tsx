...
const plans: Record<string, PlanDetails> = {
  citizen: {
    title: "Citizen Free (Demo)",
    price: "₹0",
    period: "/forever",
    desc: "For every resident. Report simulated civic issues, verify filings, earn virtual CivicScore achievements, and explore the portal.",
    features: [
      "Simulated Issue Reporting",
      "Voice Recording Translations (Gemini)",
      "Instant Dashboard Sync",
      "Virtual CivicScore Badges",
      "Local Zonal Issue Tracking",
    ],
    cta: "Try Filing Portal",
  },
  municipality: {
    title: "Municipality Pro (Demo)",
    price: "₹4,999",
    period: "/month (Simulated)",
    desc: "For testing municipal workflow simulation. Explore how zonal officers review, assign, and track mock contractor actions.",
    features: [
      "Everything in Citizen Free",
      "Zonal Command Center Dashboard",
      "Gemini AI Automated Work drafts",
      "Interactive Contractor Allocation Controls",
      "Simulated Cryptographic Ledger Audits",
      "Risk Diagnostics Diagnostics Engine",
    ],
    cta: "Simulate Zonal Deployment",
  },
  enterprise: {
    title: "Enterprise / State (Planned)",
    price: "Custom",
    period: "Request Proposal",
    desc: "Planned architectural expansion for state-level developers, regional authorities, and future smart city IoT integrations.",
    features: [
      "Everything in Municipality Pro",
      "Multi-city Administration (Planned)",
      "Satellite Imagery Scanning (Planned)",
      "Mock IoT Sensor Grid Feed Integrations",
      "GIS Data Export Layers (Planned)",
      "Custom Implementation Consultation",
    ],
    cta: "Request Demo Consultation",
  },
};
